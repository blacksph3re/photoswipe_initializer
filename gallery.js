var addHtml = function() {
  var randstring = 'pswp' + Math.random().toString(36).replace(/[^a-z]+/g, '').substr(0, 5);

  $('body').append(`
    <!-- Root element of PhotoSwipe. Must have class pswp. -->
    <div class="pswp" id="${randstring}" tabindex="-1" role="dialog" aria-hidden="true">
...
var initGallery = function(renderdiv, items) {
  var pswp = addHtml();
  addThumbnails(renderdiv, items, pswp);
}
